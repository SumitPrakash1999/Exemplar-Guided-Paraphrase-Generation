...
def main():
    # Define paths
    data_paths = {
        "train_src": "dataset-text/para-text/para/train_src.txt",
        "train_trg": "dataset-text/para-text/para/train_trg.txt",
        "valid_src": "dataset-text/para-text/para/valid_src.txt",
        "valid_trg": "dataset-text/para-text/para/valid_trg.txt",
        "test_src": "dataset-text/para-text/para/test_src.txt",
        "test_trg": "dataset-text/para-text/para/test_trg.txt",
        "word2idx": "datasets/processed/paranmt/data2/word2idx.pkl",
        "idx2word": "datasets/processed/paranmt/data2/idx2word.pkl",
        "output_dir": "datasets/processed/paranmt/data2/"         
    }
